                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="sexo" id="sexo" class="form-control {{$errors->has('sexo')?'is-invalid' : ''}}" required>
                                    ...
                                    <option value="Masculino" {{ $informacion->sexo == 'Masculino' ? 'selected' : ''}}>Masculino</option>
                                    <option value="Femenino" {{ $informacion->sexo == 'Femenino' ? 'selected' : ''}}>Femenino</option>
                                    <option value="Intersexual" {{ $informacion->sexo == 'Intersexual' ? 'selected' : '' }}>Intersexual</option>
                                </select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="convive" id="convive" class="form-control {{$errors->has('convive')?'is-invalid' : ''}}" required>
                                    ...
                                    <option value="Si" {{$informacion->convive == 'Si' ? 'selected' : ''}}>Si</option>
                                    <option value="No" {{$informacion->convive == 'No' ? 'selected' : ''}}>No</option>
                                </select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="grado" id="grado" class="form-control {{$errors->has('grado')?'is-invalid' : ''}}" required>
                                    ...
                                    <option value="Primer grado" {{ $informacion->grado == 'Primer grado' ? 'selected' : ''}}>Primer grado</option>
                                    <option value="Segundo grado" {{ $informacion->grado == 'Segundo grado' ? 'selected' : ''}}>Segundo grado</option>
                                    <option value="Tercer grado" {{ $informacion->grado == 'Tercer grado' ? 'selected' : ''}}>Tercer grado</option>
                                </select>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="extension" id="extension" class="form-control {{$errors->has('extension')?'is-invalid' : ''}}" required>
                                    ...
                                    <option value="Menor o igual al 5%" {{ $informacion->extension == 'Menor o igual al 5%' ? 'selected' : ''}}>Menor o igual al 5%</option>
                                    <option value="Del 6% al 14%" {{ $informacion->extension == 'Del 6% al 14%' ? 'selected' : ''}}>Del 6% al 14%</option>
                                    <option value="Mayor o igual al 15%" {{ $informacion->extension == 'Mayor o igual al 15%' ? 'selected' : ''}}>Mayor o igual al 15%</option>
                                </select>
                            </div>
                          </div>
