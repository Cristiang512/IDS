    ...
    <x-auth-card>
        <x-slot name="logo">
            <img src="../../dist/img/ids_logo.png"
               alt="Clínica Conquistadores"
               class="brand-image elevation-5"
               style="opacity: .8" width="220" height="220">
        </x-slot>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <select id="tipo" class="block mt-1 w-full" type="text" name="tipo" :value="old('tipo')" required autofocus>
                    <option
                    value="" > Seleccione...
                    </option>
