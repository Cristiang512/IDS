...
class SaludController extends Controller
{
    public function index($id)
    {
        ...
        'informacion.id_identificacion'
        )
        ->where('id_informacion', $id)
        ->get();

        $datos['salud']=Salud::where('id_informacion',$id)->get();
        $datos['justicia']=Justicia::where('id_informacion',$id)->get();
        $datos['proteccion']=Proteccion::where('id_informacion',$id)->get();
    ...
    public function create($id)
    {
        ...
        return view('salud.create', $datos, compact('parentesco','violencia','actividad','noFamiliar','mecanismo','sitio','escenario','ambito'));
    }
    ...
    {   
        ...
        Salud::create([
            'pro_vih' => $request->pro_vih,
            'pro_hepa' => $request->pro_hepa,
            'pro_otras' => $request->pro_otras,
            'anticoncepcion' => $request->anticoncepcion,
        ...
        return redirect('salud/'.$request->id_informacion.'/index')->with('message', 'Información del Caso Agregada con Éxito');  
    }
    ...
    public function destroy($id)
    {
        ...
        Salud::where('id_salud',$id)->delete();
