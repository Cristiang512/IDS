...
class ProteccionController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('proteccion.create', $datos, compact('parentesco','violencia','actividad','noFamiliar','mecanismo','sitio','escenario','ambito'));
    }
    ...
    {
        $query=Proteccion::where('id_proteccion',$id)
        ->select(
            'id_informacion'
        )
        ->get()
        ...
        Proteccion::where('id_proteccion',$id)->delete();
