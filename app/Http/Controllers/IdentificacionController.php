...
class IdentificacionController extends Controller
{
    ...
    {
        $datos['identificacion'] = Identificacion::leftJoin('municipio', 'municipio.id_municipio', '=', 'identificacion.id_municipio')
        ->leftJoin('tipo_documento', 'tipo_documento.id_tipo_documento', '=', 'identificacion.id_tipo_documento')
        ->select(
        ...
        return view('identificacion.index', $datos);
    }
